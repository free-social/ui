...
class _HomeViewState extends State<HomeView> {
  ...
  Widget build(BuildContext context) {
    ...
    final secondaryTextColor = isDark ? Colors.grey[400]! : const Color(0xFFAAAAAA);
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      _selectedFilter == 'All' ? "Total recently" : "Total for $_selectedFilter",
  ...
  Widget _buildFilterChip(String label, bool isDark) {
    final bool isSelected = _selectedFilter.toLowerCase() == label.toLowerCase();
    ...
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isSelected ? kPrimaryColor : (isDark ? Colors.grey[800] : Colors.grey[200]),
  ...
  Widget _buildNotificationIcon(Color bgColor, bool isDark) {
    return Container(
      ...
      child: Icon(Icons.notifications_none, size: 24, color: isDark ? Colors.white : Colors.black),
    );
  }

  Widget _buildTransactionCard(BuildContext context, TransactionModel transaction, Color cardColor, Color titleColor, Color subColor) {
    return Container(
      ...
      child: ListTile(
        ...
        leading: Container(
          ...
          child: Icon(_getCategoryIcon(transaction.category), color: _getCategoryColor(transaction.category), size: 24),
        ),
        title: Text(
          transaction.description.isNotEmpty ? transaction.description : _capitalize(transaction.category),
